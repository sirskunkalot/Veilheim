...
public static class ObjectDBExtensions
{
    internal static void Dump(this ObjectDB objectDB)
    {
        ...
        consumablesTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Consumables" + Environment.NewLine + "! Index" + Environment.NewLine +
                                "! Prefab Name" + Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine +
                                "! Max Stack Size" + Environment.NewLine + "! Food" + Environment.NewLine + "! Food Stamina" + Environment.NewLine +
                                "! Food Duration" + Environment.NewLine + "! Food Regen" + Environment.NewLine + "|-" + Environment.NewLine +
                                Environment.NewLine);
        ...
        weaponsTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Weapons" + Environment.NewLine + "! Index" + Environment.NewLine +
                            "! Prefab Name" + Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine +
                            "! Max Stack Size" + Environment.NewLine + "! Max Quality" + Environment.NewLine + "! Max Durability" + Environment.NewLine +
                            "! Damage (Phys + Ele = Total)" + Environment.NewLine + "! Per Quality" + Environment.NewLine + "! Knockback" +
                            Environment.NewLine + "! Backstab Bonus" + Environment.NewLine + "! Block Power" + Environment.NewLine + "! Deflection Force" +
                            Environment.NewLine + "! Per Quality" + Environment.NewLine + "! Timed Parry Bonus" + Environment.NewLine + "! Ammo Type" +
        ...
        void WeaponItemInfo(GameObject itemGameObject, ItemDrop.ItemData item, ref int ind)
        {
            ...
            weaponsTable.Append(
                $"| {item.m_shared.m_damages.GetTotalPhysicalDamage()} + {item.m_shared.m_damages.GetTotalElementalDamage()} = {item.m_shared.m_damages.GetTotalDamage()}{Environment.NewLine}");
            weaponsTable.Append(
                $"| {item.m_shared.m_damagesPerLevel.GetTotalPhysicalDamage()} + {item.m_shared.m_damagesPerLevel.GetTotalElementalDamage()} = {item.m_shared.m_damagesPerLevel.GetTotalDamage()}{Environment.NewLine}");
        ...
        shieldsTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Shields" + Environment.NewLine + "! Index" + Environment.NewLine +
                            "! Prefab Name" + Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine +
                            "! Teleportable" + Environment.NewLine + "! Max Quality" + Environment.NewLine + "! Max Durability" + Environment.NewLine +
                            "! Block Power" + Environment.NewLine + "! Per Quality" + Environment.NewLine + "! Deflection Force" + Environment.NewLine +
                            "! Per Quality" + Environment.NewLine + "! Timed Parry Bonus" + Environment.NewLine + "|-" + Environment.NewLine +
                            Environment.NewLine);
        ...
        armorsTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Armors" + Environment.NewLine + "! Index" + Environment.NewLine +
                           "! Prefab Name" + Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine +
                           "! Max Quality" + Environment.NewLine + "! Max Durability" + Environment.NewLine + "! Armor Value" + Environment.NewLine +
                           "! Per Quality" + Environment.NewLine + "! Movement Modifier" + Environment.NewLine + "|-" + Environment.NewLine +
                           Environment.NewLine);
        ...
        ammoTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Ammos" + Environment.NewLine + "! Index" + Environment.NewLine + "! Prefab Name" +
                         Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine + "! Max Stack Size" +
                         Environment.NewLine + "! Damage (Phys + Ele = Total)" + Environment.NewLine + "! Knockback" + Environment.NewLine + "|-" +
        ...
        otherItemsTable.Append("{| class=\"wikitable\"" + Environment.NewLine + "|+ Items" + Environment.NewLine + "! Index" + Environment.NewLine +
                               "! Prefab Name" + Environment.NewLine + "! Token Name" + Environment.NewLine + "! Localized Name" + Environment.NewLine +
                               "! Type" + Environment.NewLine + "! Teleportable" + Environment.NewLine + "! Value" + Environment.NewLine + "! Max Stack Size" +
                               Environment.NewLine + "! Max Quality" + Environment.NewLine + "|-" + Environment.NewLine + Environment.NewLine);
        ...
        foreach (var itemGameObject in objectDB.m_items)
        {
            ...
            else if (itemType == ItemDrop.ItemData.ItemType.OneHandedWeapon || itemType == ItemDrop.ItemData.ItemType.Bow ||
                     itemType == ItemDrop.ItemData.ItemType.TwoHandedWeapon || itemType == ItemDrop.ItemData.ItemType.Torch)
            {
            ...
            else if (itemType == ItemDrop.ItemData.ItemType.Helmet || itemType == ItemDrop.ItemData.ItemType.Chest ||
                     itemType == ItemDrop.ItemData.ItemType.Legs || itemType == ItemDrop.ItemData.ItemType.Shoulder)
            {
        ...
        Logger.LogWarning(consumablesTable);

        weaponsTable.Append("|}");
        Logger.LogWarning(weaponsTable);

        shieldsTable.Append("|}");
        Logger.LogWarning(shieldsTable);

        armorsTable.Append("|}");
        Logger.LogWarning(armorsTable);

        ammoTable.Append("|}");
        Logger.LogWarning(ammoTable);

        otherItemsTable.Append("|}");
        Logger.LogWarning(otherItemsTable);
    }
}